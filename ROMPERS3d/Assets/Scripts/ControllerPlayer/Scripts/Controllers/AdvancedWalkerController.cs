...
namespace CMF
{
	...
	public class AdvancedWalkerController : Controller {
        ...
        //active 2d control, Blocking y axis
		...
		protected virtual Vector3 CalculateMovementDirection()
		{
            ...
            Vector3 moveInput = InputControl.instance.getAxisControl();
        ...
        {
            Vector3 Axis = new Vector3(characterInput.GetHorizontalMovementInput(), characterInput.GetVerticalMovementInput(),0);
            return Axis;
        }
