        ...
        if (target != null)
        {
            ...
            else if (view2d)
            {
                ...
                transform.position = new Vector3(
                    ...
                    targetPos.y,
                    Mathf.Clamp(targetPos.z, limitZ.x, limitZ.y));
                Camera.main.transform.localPosition = new Vector3(Camera.main.transform.localPosition.x, Camera.main.transform.localPosition.y, Camera.main.transform.localPosition.z);
            }
